...
from apps.api.permissions import IsOwnerOrHasRBACPermissions, RBACPermission, has_permissions
...
class UserView(
    ...
    def get_serializer_class(self):
        ...
        has_admin_permission = has_permissions(user.permissions, [RBACPermission.Permissions.USER_SETTINGS_ADMIN])
