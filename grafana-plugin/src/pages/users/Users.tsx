...
class Users extends React.Component<UsersProps, UsersState> {
  ...
  updateUsers = async () => {
    ...
    if (!store.isUserActionAllowed(UserAction.UserSettingsWrite)) {
      return;
    }
  ...
  componentDidUpdate(prevProps: Readonly<UsersProps>, prevState: Readonly<UsersState>, snapshot?: any) {
    ...
    if (!this.initialUsersLoaded && store.isUserActionAllowed(UserAction.UserSettingsWrite)) {
      this.updateUsers();
          ...
          <>
            <div className={cx('root')}>
              <div className={cx('root', 'TEST-users-page')}>
                ...
                {store.isUserActionAllowed(UserAction.UserSettingsRead) ? (
                  <>
